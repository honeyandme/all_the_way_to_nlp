...
class Linear(Module):
    ...
    def backward(self, G):
        ...
        # self.W.weight -= lr * (self.u*self.last_w_grad+(1-self.u)*self.W.grad)
        # self.last_w_grad = self.W.grad
        #
        # self.b.weight -= lr * (self.u*self.last_b_grad+(1-self.u)*self.b.grad)
        # self.last_b_grad = self.b.grad
